...
# NOTE: Use hard tabs when working on this file, no 4-to-8-spaces auto-tab ViM nonsense!
...
frameP1 = tk.LabelFrame(frameMain, bd = 0, text = "Introduction")
frameP2 = tk.LabelFrame(frameMain, bd = 0, text = "Brush Configuration")
frameP3 = tk.LabelFrame(frameMain, bd = 0, text = "Color Configuration")
frameP4 = tk.LabelFrame(frameMain, bd = 0, text = "Conclusion & Instructions")
...
#Exit handler
def exitHandler():
	if mbx.askyesno("Confirmation", "Are you sure you want to close this wizard?"):
		base.destroy()

#Declare and grid the close button
buttonClose = tk.Button(frameP4, text = "Close", font = fontNormal, command = exitHandler, cursor = "hand2")
buttonClose.grid(row = 12, column = 2)
...
OptionSet1 = tk.Checkbutton(frameP3, font = fontNormal, anchor = tk.W, variable = page3Vars[2], text = "HSY Wheel")
OptionSet2 = tk.Checkbutton(frameP3, font = fontNormal, anchor = tk.W, variable = page3Vars[3], text = "HSV Wheel")
OptionSet3 = tk.Checkbutton(frameP3, font = fontNormal, anchor = tk.W, variable = page3Vars[4], text = "Color Palette")
OptionSet4 = tk.Checkbutton(frameP3, font = fontNormal, anchor = tk.W, variable = page3Vars[5], text = "HSV Cube")
OptionSet5 = tk.Checkbutton(frameP3, font = fontNormal,anchor = tk.W, variable=page3Vars[6], text ="Add Color to Palette")
...
labelResultsHead = tk.Label(frameP4, font = fontNormal, bd = 2, relief = "ridge", justify = tk.LEFT, text = "Brush-related items to set up:")
labelResultsHead.grid(row = 1, column = 1, sticky = tk.W)
labelResults = tk.Label(frameP4, font = fontNormal, bd = 2, relief = "ridge", justify = tk.LEFT, wraplength = 640, textvariable = resultString)
labelResults.grid(row = 2, column = 1, columnspan = 2, sticky = tk.W)

#Decorate page 5
#def updatePage5():
	
labelResHead = tk.Label(frameP4, font = fontNormal, bd = 2, relief = "ridge", justify = tk.LEFT, text = "Color-related items to set up:")
labelResHead.grid(row = 3, column = 1, sticky = tk.W)
labelRes = tk.Label(frameP4, font = fontNormal, bd = 2, relief = "ridge", justify = tk.LEFT, wraplength = 640, textvariable = results)
labelRes.grid(row = 4, column = 1, columnspan = 2, sticky = tk.W)
